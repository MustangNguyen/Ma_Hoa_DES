...
namespace Ma_Hoa_DES.MaHoa
{
    class ChuoiNhiPhan
    {
        ...
        //Dùng để điều chỉnh độ dài của chuỗi nhị phân khi không đủ 64 bit 
        ...
        //Khi giải mã chúng ta cần loại bỏ các bit bù đi để giải mã các bit đúng
