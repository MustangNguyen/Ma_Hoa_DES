...
namespace Ma_Hoa_DES.MaHoa
{
    class Khoa
    {
        ...
        public void SinhKhoaCon()
        {
            ...
            // b1: tính PC1
            ChuoiNhiPhan[] ChuoiSauPC1 = ThongSo.TinhPC1(KhoaChinhNhiPhan);
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                // vòng 1,2,9 là 1 bit
                // còn lại dịch 2 bit
                C0 = C0.DichTraiBit(ThongSo.soBitDichTaiCacVong[i]);
                D0 = D0.DichTraiBit(ThongSo.soBitDichTaiCacVong[i]);
                // Khóa phụ thu được sau khi tính PC2 từ C và D
                MotKhoaPhu = ThongSo.TinhPC2(C0, D0);
